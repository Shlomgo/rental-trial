"""
Metro configuration: Baldwin County, AL (Gulf Coast).
...
METRO_AREA = "Baldwin County, AL"
METRO_SLUG = "baldwin-county-al"
...
# doubles as the actual city filter for builder discovery, since builder
# region paths for this metro are broader than the county itself (see below).
CITIES = [
    "Fairhope", "Daphne", "Foley", "Spanish Fort", "Loxley", "Robertsdale",
    "Gulf Shores", "Orange Beach", "Bay Minette", "Elberta", "Summerdale",
    "Silverhill", "Magnolia Springs", "Stapleton", "Point Clear", "Malbis",
]
...
#   D.R. Horton:  https://www.drhorton.com/alabama/baldwin-county/<city>/<community>
#   Lennar:       https://www.lennar.com/new-homes/alabama/mobile-baldwin/<city>/<community>
#     (this region also covers Mobile County - CITIES filters that back out)
DR_HORTON_REGION_PATH = "alabama/baldwin-county"
LENNAR_REGION_PATH = "new-homes/alabama/mobile-baldwin"
...
DASHBOARD_ARTIFACT_URL = "https://claude.ai/code/artifact/dca9b9f3-f9a8-4b83-a165-eb7e8964315f"
